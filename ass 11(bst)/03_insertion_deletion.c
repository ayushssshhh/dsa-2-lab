...
struct node* del_node(struct node* ptr , int v){
    
    if(ptr->data < v){
        if(ptr->right == NULL){
            printf("\nnode with %d value is not found in the list",v);
            return NULL;
        }

        ptr->right = del_node(ptr->right , v);
    }
...
int main(){
    ...
    do
    {
        ...
        switch (n)
        {
            ...
            case 8 :
                printf("\nenter the value of node to delete from bst : ");
                scanf("%d",&v);
                del_node(root , v);
                break;
...
// 1 11 15 30 17 5 8 4 40 9 32 50 3 y 2 y 3 y 4 y 5 y 6 y 7 51 y 7 2 y 5 y 6 y 8 

// 1 11 15 30 17 5 8 4 40 9 32 50 3 y 2 y 8 30